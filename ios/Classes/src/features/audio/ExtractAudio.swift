...
/// - Supports multiple output formats (MP3, AAC, M4A)
...
class ExtractAudio {
    ...
    ///
    /// This method uses AVAssetExportSession to export only the audio track
    /// from the source video. It supports optional trimming and provides
    /// progress callbacks during the export process.
    ///
    /// - Parameters:
    ...
    static func extract(
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            do {
                ...
                session.outputFileType = .m4a // M4A container for AAC audio
                    ...
                    case .completed:
                        do {
                            if config.outputPath != nil {
                                ...
                                // Memory output - read file and return bytes
